      ...
      >
        <div className="glass-card">
          <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
            ...
            <p style={{ color: 'var(--text-secondary)' }}>Start your interview journey today</p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="input-group">
              ...
              <div style={{ position: 'relative' }}>
                <User style={{ position: 'absolute', left: '1.25rem', top: '50%', transform: 'translateY(-50%)', color: 'var(--text-secondary)', width: '1.5rem' }} />
                <input
                  type="text"
                  required
                  value={name}
